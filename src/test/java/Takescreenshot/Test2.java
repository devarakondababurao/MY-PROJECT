...
public class Test2 {
		...
		TakeScreenShotAuto(driver,"C:\\HTML Report\\test-output\\TempScreenShots\\today\\ScreenShot1.png");
		
		findElement(By.id("txtUsername")).sendKeys("Admin");
		TakeScreenShotAuto(driver,"C:\\HTML Report\\test-output\\TempScreenShots\\today\\ScreenShot2.png");
		
		findElement(By.name("txtPassword")).sendKeys("admin123");
		TakeScreenShotAuto(driver,"C:\\HTML Report\\test-output\\TempScreenShots\\today\\ScreenShot3.png");
