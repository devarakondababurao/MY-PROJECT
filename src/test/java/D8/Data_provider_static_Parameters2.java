...
public class Data_provider_static_Parameters2 {
	...
	public  static Object[][] testdataprovider()throws Exception{
		return new Object[][] {
        	...
        	public void Login_Test(String TestURL,String UserName,String Password,String Nationality) throws Exception
        	{
        		...
        		Data_provider_static_Parameters2.OpenChromeBrowser();
        		Data_provider_static_Parameters2.OpenOrangeHRM(TestURL);
        		Data_provider_static_Parameters2.Login(UserName,Password);
