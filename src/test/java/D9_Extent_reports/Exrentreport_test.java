...
public class Exrentreport_test {
...
WebDriver driver;
	...
	public void Report3_Test() throws Exception {
		...
		screenShotPath = ExtentReport.capture(driver,TestScriptName);
		logger.pass("Login Page - Entered user Name",MediaEntityBuilder.
		...
		screenShotPath = ExtentReport.capture(driver,TestScriptName);
		logger.fail("Login Page - Clicked on Login",MediaEntityBuilder.
				createScreenCaptureFromPath(screenShotPath).build());
