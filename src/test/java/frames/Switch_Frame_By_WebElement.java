...
public class Switch_Frame_By_WebElement {
	...
	findElement(By.name("firstname")).sendKeys("ram");
	findElement(By.name("lastname")).sendKeys("raju");
	findElement(By.name("subject1")).sendKeys("ram raju");
	
	driver.switchTo().defaultContent();
	
	driver.switchTo().frame(findElement(By.id("AmazonContactForm")));
	
	findElement(By.name("firstname")).sendKeys("hallo");
	findElement(By.name("lastname")).sendKeys("world");
	findElement(By.name("subject")).sendKeys("i am babi");
	driver.switchTo().defaultContent();
